...
class DCatAPI:
    ...
    def register_datasets(self, provenance_id, metadata):
        for obj in metadata:
            ...
            return self.register_dataset_with_multiple_resources(
                provenance_id, name, description, variables, resources_metadata
            )
    ...
    def delete_resources(self, provenance_id, resource_ids):
        ...
        for resource_id in resource_ids:
            resource_defs = {"provenance_id": provenance_id, "resource_id": resource_id}
    ...
    def delete_datasets(self, provenance_id, dataset_ids):
        ...
        for resource_id in dataset_ids:
            resource_defs = {"provenance_id": provenance_id, "dataset_id": resource_id}
