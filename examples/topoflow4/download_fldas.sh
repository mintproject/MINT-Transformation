...
#            wget "https://data.mint.isi.edu/files/raw-data/FLDAS/FLDAS_NOAH01_A_EA_D.001/$YEAR/$MONTH/FLDAS_NOAH01_A_EA_D.A$DATE.001.nc" || :
            download_files+=("https://data.mint.isi.edu/files/raw-data/FLDAS/FLDAS_NOAH01_A_EA_D.001/$YEAR/$MONTH/FLDAS_NOAH01_A_EA_D.A$DATE.001.nc")
        fi
    done

    echo ${download_files[@]} | xargs -n 1 -P 32 wget -q
else
