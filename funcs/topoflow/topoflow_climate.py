...
class Topoflow4ClimateWriteFunc(IFunc):
    ...
    def __init__(self, geotiff_files: Union[str, List[str]], cropped_geotiff_dir: str, output_file: str, bounds: str, xres_arcsecs: int, yres_arcsecs: int, unit_multiplier: float=1):
    ...
    def exec(self) -> dict:
        create_rts_rti(self.geotiff_files, self.output_file, self.cropped_geotiff_dir, self.bounding_box, self.xres_arcsecs, self.yres_arcsecs, self.unit_multiplier)
